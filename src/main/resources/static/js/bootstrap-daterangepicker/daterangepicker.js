...
!function ($, moment) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="clearBtn btn btn-link" ></button>&nbsp;' +
    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function () {
            ...
            } else if (this.element.is('div') && !this.singleDatePicker) {
                this.element.find('input').val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
            } else if (this.element.is('div')) {
                this.element.find('input').val(this.startDate.format(this.format));
            }
        },
